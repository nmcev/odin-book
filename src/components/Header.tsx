...
export const Header: React.FC = () => {
  ...
  return (
      <header className='sm:flex w-full justify-evenly sm:py-4 fixed backdrop:blur-xl top-0 bg-[rgba(255,255,255,0.85)] dark:backdrop:opacity-50 dark:bg-[#101010] z-50'>
